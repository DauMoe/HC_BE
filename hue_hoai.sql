...
INSERT INTO `excercise` (`excerID`, `excer_name`, `bmi_from`, `bmi_to`, `excer_url`, `description`) VALUES
...
(2, 'Chair Squat', 15, 18.5, '.\\picture\\cap-do-de\\chairSquat.mp4', 'Hướng dẫn:\r\n  Đứng phía trước ghế, hai chân bằng vai, mũi chân hơi hướng ra 2 bên. Gập người ở hông và khuỵu gối xuống, hạ người về sau và hướng xuống, cho tới khi nào mông chạm vào ghế phía sau, duỗi thẳng 2 tay ra phía trước. Dùng lực gót chân, đẩy người đứng dậy và quay trở lại vị trí ban đầu'),
...
(10, 'Bicycle Crunch', 15, 20, '.\\picture\\cap-do-de\\BicycleCrunch.mp4', 'Hướng dẫn: \r\n - Nằm ngửa lưng trên sàn, đưa 2 chân lên cao. Gập cùi chỏ và đặt 2 tay ra sau đầu.\r\n - Gập người lên và đưa cùi chỏ phải chạm vào gối trái, duỗi thẳng chân phải.\r\n - Hạ người xuống vừa phải, gập chân phải và duỗi thẳng chân trái, sau đó kéo cùi chỏ trái chạm vào gối phải. lặp lại.'),
(11, 'Single-Leg Bridge', 18.5, 29.9, '.\\picture\\cap-do-tb\\Single Leg Bridge Left.mp4', 'Đây là bài tập ở nhà khá khó cho nhiều người, nên bạn cần thực hiện đúng những gì video hướng dẫn nhé.'),
(12, 'Squat', 18.5, 29.9, '.\\picture\\cap-do-tb\\Squat.vn.mp4', 'Nếu như ở cấp độ dễ, bạn có 1 chiếc ghế để giữ thăng bằng, giúp bạn tạp đúng kỹ thuật, thì ở cấp độ này, bạn sẽ tự tập mà không có ghế.'),
(13, 'Pushup', 18.5, 29.9, '.\\picture\\cap-do-tb\\Push ups.vn.mp4', 'Động tác hít đất đúng kỹ thuật chắc chắn sẽ khó hơn động tác biến thể, với gối ở trên sàn.Xem video để hít đất đúng cách nhé.'),
(14, 'Walking Lunge', 18.5, 29.9, '.\\picture\\cap-do-tb\\Walking Lunges.mp4', 'Thay vì chỉ thực hiện động tác lunge tại chỗ, bạn sẽ phải tăng độ khó hơn một tí bằng cách thực hiện động tác bổ sung là đi.'),
(15, 'Pike Pushups', 18.5, 29.9, '.\\picture\\cap-do-tb\\Pike Pushup.mp4', 'Gia tăng độ khó cho bào hít đất, bằng cách đẩy người lên cao, sẽ tập trung vào vùng cơ vai nhiều hơn. Ngoài ra, động tác này còn kích thích lên sức mạnh của cơ tay, giúp giữ thăng bằng cho thân người'),
(16, 'Get-up Squat', 18.6, 35, '.\\picture\\cap-do-tb\\The Squat Get Up.mp4', 'Đây là động tác giúp cơ chân và mông luôn bị dồn ép dưới áp lực, nhằm đốt mỡ thừa và xây dựng cơ.'),
(17, 'Superman', 18.6, 35, '.\\picture\\cap-do-tb\\Superman.mp4', 'Động tác này sẽ tác động vào vùng lưng dưới và toàn bộ vùng thân người dưới của bạn.'),
(18, 'Plank with Alternating Leg Lift', 18.6, 35, '.\\picture\\cap-do-tb\\Plank with Leg Lift .mp4', 'Đây là động tác biến thể cho động tác Plank, giúp bạn tăng độ khó lên, khó giữ thăng bằng hơn và đòi hỏi các vùng cơ trên toàn thân người phải hoạt động tối đa để trợ giúp 4 chi.'),
(19, 'Kneeling Side Plank with Hip Abduction', 18.6, 35, '.\\picture\\cap-do-tb\\Side plank with hip abduction.mp4', 'Bài tập này sẽ vận dụng sức mạnh toàn thân người, giúp cơ thể giữ thăng bằng.'),
(20, 'Dead Bug', 18.6, 35, '.\\picture\\cap-do-tb\\Dead Bug.mp4', 'Động tác này nhằm kích thích các bó cơ toàn thân người phát triển tối đa.'),
(21, 'Bridge with Leg Extended', 20, 40, '.\\picture\\cap-do-nang-cao\\Bridge with Leg Extension.mp4', ''),
(22, 'Overhead squat', 20, 40, '.\\picture\\cap-do-nang-cao\\Overhead Squats.mp4', ''),
(23, 'One-legged pushup', 20, 40, '.\\picture\\cap-do-nang-cao\\One Leg Push Ups.mp4', NULL),
(24, 'Jumping lunges', 20, 40, '.\\picture\\cap-do-nang-cao\\Jumping Lunge .mp4', NULL),
(25, 'Elevated pike pushups', 20, 40, '.\\picture\\cap-do-nang-cao\\Pike Push Up.mp4', NULL),
(26, 'Get-up squat with jump', 20, 40, '.\\picture\\cap-do-nang-cao\\Jump Squat .mp4', NULL),
(27, 'Advanced Bird Dog', 20, 40, '.\\picture\\cap-do-nang-cao\\Advanced Bird Dog.mp4', NULL),
(28, 'One-leg or one-arm plank', 30, 40, '.\\picture\\cap-do-nang-cao\\Single Arm Single Leg Plank.mp4', NULL),
(29, 'Side plank with hip abduction', 30, 40, '.\\picture\\cap-do-nang-cao\\Side plank with hip abduction .mp4', NULL),
(30, 'Hollow hold to jackknife', 30, 40, '.\\picture\\cap-do-nang-cao\\Hollow Knee Tuck .mp4', NULL),
(31, 'Pull-ups', 18.5, 30, '.\\picture\\lung-va-bap-tay\\Pull ups.mp4', 'Hướng dẫn:\r\n - Hai tay nắm chắc thanh xà, lòng bàn tay hướng ra trước, cánh tay duỗi thẳng, ngửa người ra sau khoảng 30 độ.\r\n - Kéo thân lên đến khi ngực trên chạm xà, siết cơ lưng, giữ 1 giây, thở ra khi kéo lên.\r\n - Hít ào và hạ thân xuống.'),
(32, 'Chin-ups', 18.5, 30, '.\\picture\\lung-va-bap-tay\\Chin-Up.mp4', 'Đây là một biến thể của Pull-ups. Điểm khác biệt lớn nhất chính là lòng bàn tay nắm thanh xà của bạn hướng vào trong, về phía người.'),
(33, 'Wide Grip Pull-ups', 18.5, 30, '.\\picture\\lung-va-bap-tay\\Wide grip pull up.mp4', 'Cũng là pull-ups, nhưng vị trí 2 tay của bạn mở rộng hơn so với bình thường.'),
(34, 'Narrow Grip Pull-ups', 18.5, 30, '.\\picture\\lung-va-bap-tay\\Narrow Grip Pull Ups.mp4', 'Cũng là pull-ups nhưng ở bài này yều cầu bạn đặt 2 tay gần nhau hơn bình thường, lòng bàn tay hướng ra ngoài.'),
(35, 'Pull-up Hold', 18.5, 30, '.\\picture\\lung-va-bap-tay\\Pull up hold .mp4', 'Đây là bài tập cải thiện sức bền tuyệt vời nhất. Bạn chỉ cần nắm thanh xà, kéo người lên và đặt cằm mình ở trên thanh, rồi giữ nguyên vị trí đó càng lâu càng tốt. '),
(36, 'Dips', 18.5, 25, '.\\picture\\nguc-va-tay-sau\\Dips   Triceps .mp4', 'Hướng dẫn:\r\n - Hai tay nắm lấy 2 thanh xà, tay hơi duỗi thẳng.\r\n - Hít vào, hạ người xuống từu từ đến khi tay trên và cẳng tay tạo thành 1 góc vuông, thân người vẫn giữ thẳng, giữ cùi chỏ sát người.\r\n - Đẩy người về vị trí ban đầu dùng lực cơ tay sau.'),
(37, 'Push-ups', 18.5, 25, '.\\picture\\nguc-va-tay-sau\\Push ups.mp4', 'Hướng dẫn :\r\n - Hai tay và hai chân chống xuống sàn, tay mở rộng hơn vai, thân người tao thành một đường thẳng từ đầu đến gót chân.\r\n - Hít vào, từ từ hạ người xuống cho đến khi ngực gần chạm sân.\r\n - Đẩy người trở về vị trí ban đầu, đồng thời căng cơ ngực và thở ra.'),
(38, 'Diamond Push-ups', 18.5, 25, '.\\picture\\nguc-va-tay-sau\\Diamond Push-Up.mp4', 'Hướng dẫn:\r\n - Tạo tư thế tương tự như khi hít đất, lưng thẳng, 2 tay để sát lại nhau, các ngón tay tạo hình cho ngón cái và ngón trỏ chạm vào nhau tạo thành hình viên kim cương, cánh tay duỗi thẳng.\r\n - Hít vào và hạ người xuống đến khi ngực gần chạm sàn.\r\n - Đẩy người về vị trí ban đầu, thở ra dứt khoát.'),
(39, 'Bench Dips', 18.5, 25, '.\\picture\\nguc-va-tay-sau\\Bench Dips.mp4', 'Hướng dẫn: \r\n - Đặt ghế sau lưng, đặt 2 tay lên cạnh ghế, tay mở rộng bằng vai.\r\n - Từ từ hạ thấp người, đồng thời hít vào.\r\n - Dùng lực cơ tay sau để nâng người lên và thở ra.'),
(40, 'Clap Push-ups', 18.5, 25, '.\\picture\\nguc-va-tay-sau\\Clapping Push Ups .mp4', 'Hướng dẫn: \r\n - Tạo tư thế hít đất, 2 tay đặt rộng hơn vai, siết cơ bụng\r\n - Từ từ hạ người xuống, cùng lúc hít vào\r\n - Duỗi thẳng tay, bật người lên, vỗ tay thật nhanh, thở ra và hạ người trở về vị trí ban đầu.'),
(41, 'Handstand Push-ups', 25, 35, '.\\picture\\tang-co\\Handstand Push-ups .mp4', 'Hướng dẫn:\r\n - Tựa 2 chân vào tường, tay chống xuống đất, người thẳng\r\n - HÍt vào, gống người và từu từ hạ xuống\r\n - Đẩy người lên đồng thời thở ra.'),
(42, 'Pike Push-ups', 25, 35, '.\\picture\\tang-co\\Pike Push-Upsl.mp4', 'Hướng dẫn:\r\n - Tạo tư thế hít đất, 2 tay mở rộng bằng vai duỗi thẳng\r\n - Đẩy hong lên co cho đến khi cả người tạo hình chữ V úp ngược, cố gắng duỗi thẳng tay và chân\r\n - Hít vào và gập cùi chỏ, hạ thân trên xuống đến khi đỉnh đầu gần chạm xuống sàn\r\n - Giữu yên vài giây, hít vào và đẩy người về vị trí ban đầu đến khi 2 tay duỗi thẳng'),
...
--
ALTER TABLE `ex_mapping`
  MODIFY `ex_mappingID` int(11) NOT NULL AUTO_INCREMENT;
